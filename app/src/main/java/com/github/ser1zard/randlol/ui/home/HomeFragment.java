  ...
  public View onCreateView(@NonNull LayoutInflater inflater,
    ...
    random.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        championRandom.setImageResource(getResources().getIdentifier(randomPick.get(1), "drawable",
            getContext().getPackageName()));
        laneRandom.setImageResource(getResources().getIdentifier(randomPick.get(0), "drawable",
            getContext().getPackageName()));
      }
    });
